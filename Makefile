...
.PHONY: format clean run-fml fml fml_debug run-parser-tests
...
clean:
	rm -f $(MAIN_EXECUTABLE_FILE) $(DEBUG_EXECUTABLE_FILE) $(OBJECT_FILES) $(DEBUG_OBJECT_FILES) $(PARSER_TESTS_EXECUTABLE_FILE) $(PARSER_TESTS_OBJECT_FILES)
